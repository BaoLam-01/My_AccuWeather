...
object ConstantsApi {
    ...
    * */
    ...
    const val ACCU_API_KEY = "Dg98nYAeVGcVxD55lEokoKLLypiYTDGC"
...
//    const val GET_CURRENT_WEATHER = "currentconditions/v1/{locationkey}?apikey=$ACCU_API_KEY&language=vi&details=true"
    const val GET_HOURLY_WEATHER = "forecasts/v1/hourly/12hour/{locationkey}?apikey=$ACCU_API_KEY&language=vi&details=true&metric=true"
//    const val GET_DAILY_WEATHER = "forecasts/v1/daily/5day/{locationkey}?apikey=$ACCU_API_KEY&language=vi&details=true&metric=true"
    const val GET_DAILY_1DAY_WEATHER = "forecasts/v1/daily/1day/{locationkey}?apikey=$ACCU_API_KEY&language=vi&details=true&metric=true"
    const val GET_CITY_NAME = "locations/v1/cities/neighbors/{locationkey}?apikey=$ACCU_API_KEY&language=vi&details=false"
    const val GET_LOCATION_KEY = "locations/v1/cities/geoposition/search?apikey=$ACCU_API_KEY&language=vi&details=false"
    const val GET_INF_BY_CITY_NAME = "locations/v1/cities/search?apikey=$ACCU_API_KEY&language=vi&details=true&offset=3"
    const val GET_UV_INDEX = "currentconditions/v1/{locationkey}?apikey=$ACCU_API_KEY&language=vi&details=true"
    ...
    const val GET_CURRENT_WEATHER = "data/2.5/weather?appid=$OPEN_API_KEY&units=metric&lang=vi"

//    https://api.openweathermap.org/data/2.5/forecast?q=hanoi&appid=69fd62aa169ae9c49a1bc43f21ac0926&units=metric&lang=vi
    const val GET_DAILY_WEATHER = "data/2.5/forecast?appid=$OPEN_API_KEY&units=metric&lang=vi"
//    https://api.openweathermap.org/data/2.5/air_pollution?lat=20.988511&lon=105.771125&appid=69fd62aa169ae9c49a1bc43f21ac0926
    const val GET_AIR_QUALITY = "https://api.openweathermap.org/data/2.5/air_pollution?appid=$OPEN_API_KEY"
